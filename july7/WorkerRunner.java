class WorkerRunner{
	public static void main(String[] args){
	    ...
	    Worker ref1 = new Worker("Raju" , 9 , "10hours" , "male" , 19999.9);
	    ref1.info();
	    System.out.println(" ");
        ...
        Worker ref2 = new Worker("Surekha" , 10 , "8hours" , "female" , 16999.9);
	    ref2.info();
		System.out.println(" ");
	
	
	    System.out.println("calling 3rd constructor from WorkerRunner...");
        Worker ref3 = new Worker("pooja" , 12 , "6hours" , "female" , 9999.9);
	    ref3.info();
		System.out.println(" ");
