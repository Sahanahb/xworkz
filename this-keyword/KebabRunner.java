public class KebabRunner{
    public static void main(String[] args) 
    {
        ...
        Kebab ref2=new Kebab("Tandoori kebab",200);
        ...
        Kebab ref3=new Kebab("Chicken kebab",250.50,"Hassan Famous");
        ...
        Kebab ref4=new Kebab("Tandoori kebab",180.50,"Shivanna Kebab",4);
        ...
        Kebab ref5=new Kebab("Tandoori kebab",180.50,"Shivanna Kebab",4,true);
