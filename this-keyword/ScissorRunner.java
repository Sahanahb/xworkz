public class ScissorRunner{
    public static void main(String[] args) 
    {
        ...
        Scissors ref1=new Scissors("Tailoring Scissorss");
        ...
        Scissors ref2=new Scissors("Tailoring Scissorss","Black");
        ...
        Scissors ref3=new Scissors("Tailoring Scissorss","Black","sharpestBlade");
        ...
        Scissors ref4=new Scissors("Tailoring Scissorss","Black","sharpestBlade","Tailor Shop");
        ...
        Scissors ref5=new Scissors("Tailoring Scissorss","Black","sharpestBlade","Tailor Shop",'S');
        ...
        Scissors ref6=new Scissors("Tailoring Scissorss","Black","sharpestBlade","Tailor Shop",'S',1666);
        ...
        Scissors ref7=new Scissors("Tailoring Scissorss","Black","sharpestBlade","Tailor Shop",'S',1666,"metal");
